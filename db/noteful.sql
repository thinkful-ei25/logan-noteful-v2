...
-- SELECT * FROM notes WHERE title = '11 ways investing in cats can make you a millionaire';

-- Select notes where title is LIKE a string. In other words the title contains the word or phrase (e.g cats or ways)
-- SELECT * FROM notes Where title LIKE '%government%' LIMIT 5;

-- Update the title and content of a specific note.
-- UPDATE notes SET title = 'CATS CATS CATS', content = 'CATS CATS CATS CATS CATS CATS CATS CATS CATS CATS CATS CATS' WHERE id = 5;
-- SELECT * FROM notes WHERE id = 5;

-- Insert a new note. Try providing incomplete data like missing content or title fields.
-- INSERT INTO notes (title) VALUES ('DOGS') RETURNING id, title, content, created;
